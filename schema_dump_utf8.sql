...
\restrict 6EKguBRxjg91NocR8e7KogFwVn7r7A637ckHP9Gx69gXWQ3a1ElDgJ0ULUiUuxB
...
--
-- Name: cart_items cart_items_user_id_product_id_variant_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: product_variant_attributes product_variant_attributes_variant_id_attribute_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.product_variant_attributes
    ADD CONSTRAINT product_variant_attributes_variant_id_attribute_id_key UNIQUE (variant_id, attribute_id);
...
--
-- Name: objects Authenticated users can upload review images.; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Authenticated users can upload review images." ON storage.objects FOR INSERT WITH CHECK (((bucket_id = 'review-images'::text) AND (auth.role() = 'authenticated'::text)));


--
-- Name: objects Public review images are viewable by everyone.; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Public review images are viewable by everyone." ON storage.objects FOR SELECT USING ((bucket_id = 'review-images'::text));


--
-- Name: objects Users can delete their own review images.; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Users can delete their own review images." ON storage.objects FOR DELETE USING (((bucket_id = 'review-images'::text) AND (auth.uid() = owner)));


--
-- Name: objects Users can update their own review images.; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "Users can update their own review images." ON storage.objects FOR UPDATE USING (((bucket_id = 'review-images'::text) AND (auth.uid() = owner)));


--
-- Name: objects View 1ifhysk_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "View 1ifhysk_0" ON storage.objects FOR SELECT USING ((bucket_id = 'products'::text));
...
--
-- Name: objects delete 1ifhysk_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "delete 1ifhysk_0" ON storage.objects FOR DELETE TO authenticated USING ((bucket_id = 'products'::text));
...
--
-- Name: objects upload 1ifhysk_0; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY "upload 1ifhysk_0" ON storage.objects FOR INSERT TO authenticated WITH CHECK ((bucket_id = 'products'::text));
...
--
-- Name: SEQUENCE product_variant_attributes_id_seq; Type: ACL; Schema: public; Owner: postgres
--
...
\unrestrict 6EKguBRxjg91NocR8e7KogFwVn7r7A637ckHP9Gx69gXWQ3a1ElDgJ0ULUiUuxB
